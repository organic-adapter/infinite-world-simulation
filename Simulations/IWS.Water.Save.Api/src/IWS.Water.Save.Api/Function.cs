...
public class Function
{
	...
	public WaterTick FunctionHandler(Stream stream)
	{
		var response = messageHandler.HandleAsync<WaterTick>(stream, waterManager.SaveAsync).Result;
