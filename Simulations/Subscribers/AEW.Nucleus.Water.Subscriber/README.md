...
```bash
AEW.Nucleus.Water.Subscriber$ sam build
```
...
```bash
AEW.Nucleus.Water.Subscriber$ sam local invoke helloFromLambdaFunction --no-event
```
...
Resources:
  ...
  helloFromLambdaFunction:
    ...
    Properties:
      CodeUri: ./src/AEW.Nucleus.Water.Subscriber/
...
```bash
AEW.Nucleus.Water.Subscriber$ sam deploy
```
...
```bash
AEW.Nucleus.Water.Subscriber$ sam logs -n helloFromLambdaFunction --stack-name sam-app --tail
```
...
```bash
AEW.Nucleus.Water.Subscriber$ dotnet test test/AEW.Nucleus.Water.Subscriber.Tests/AEW.Nucleus.Water.Subscriber.Tests.csproj 
```
...
```bash
aws cloudformation delete-stack --stack-name AEW.Nucleus.Water.Subscriber
```
